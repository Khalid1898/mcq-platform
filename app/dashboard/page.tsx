      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <SkillCard
            ...
            levelLabel={`Level ${Math.max(
              1,
              Math.round((state.skillProgress.reading || 0) / 10)
            )}`}
          ...
          <SkillCard
            ...
            levelLabel={`Level ${Math.max(
              1,
              Math.round((state.skillProgress.writing || 0) / 10)
            )}`}
          ...
          <SkillCard
            ...
            levelLabel={`Level ${Math.max(
              1,
              Math.round((state.skillProgress.listening || 0) / 10)
            )}`}
          ...
          <SkillCard
            ...
            levelLabel={`Level ${Math.max(
              1,
              Math.round((state.skillProgress.speaking || 0) / 10)
            )}`}
